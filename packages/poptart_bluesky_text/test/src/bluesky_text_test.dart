import 'package:poptart_bluesky_text/src/bluesky_text.dart';
import 'package:poptart_bluesky_text/src/config/link_config.dart';
import 'package:poptart_bluesky_text/src/entities/entity.dart';
import 'package:test/test.dart';

void main() {
  test('.value', () {
    const text = BlueskyText('test');
  ...
  group('.length', () {
    test('normal case', () {
      const text = BlueskyText('aaaaa');

      expect(text.length, 5);
    });

    test('with spaces', () {
      const text = BlueskyText('aa a　');
  ...
  group('.handles', () {
    test('case1', () {
      const text = BlueskyText('😳 @test.bsky.social');
    ...
    test('case6', () {
      const text = BlueskyText('@shinyakato.dev');
      final handles = text.handles;
    ...
    test('case7', () {
      const text = BlueskyText('@shinyakato.bsky.social');
      final handles = text.handles;
    ...
    test('case14', () {
      const text = BlueskyText("😳 @test.bsky.social'test'");
      final handles = text.handles;
    ...
    test('case17', () {
      const text = BlueskyText('@shinyakato.test');
      final handles = text.handles;
    ...
    test('case18', () {
      const text = BlueskyText('テスト@shinyakato.dev試験');
      final handles = text.handles;
    ...
    test('case19', () {
      const text = BlueskyText('@shinyakato.dev@shinyakato.bsky.social');
      final handles = text.handles;
    ...
    test('case20', () {
      const text = BlueskyText('contact@shinyakato.dev');
      final handles = text.handles;
    ...
    group('extended handle tests', () {
      ...
      test('handle facet generation', () async {
        const text = BlueskyText('@alice.dev @bob.org @charlie.net');
        final handles = text.handles;
  ...
  group('.links', () {
    test('case1', () {
      const text = BlueskyText('😳 https://test.com');
    ...
    test('case2', () {
      const text = BlueskyText('https://test.com https://test.org');
      final links = text.links;
    ...
    test('case5', () {
      const text = BlueskyText('https://test.com. test.org.');
      final links = text.links;
    ...
    test('case6', () {
      const text = BlueskyText('test.com');
      final links = text.links;
    ...
    test('case7', () {
      const text = BlueskyText('test.test');
      final links = text.links;
    ...
    test('case14', () {
      expect(const BlueskyText('tbh').links, []);
    });

    test('case15', () {
      const text = BlueskyText('https://atprotodart.com');
      final links = text.links;
    ...
    test('case16', () {
      const text = BlueskyText('atprotodart.com');
      final links = text.links;
    ...
    test('case17', () {
      const text = BlueskyText('atprotodart.com/test');
      final links = text.links;
    ...
    test('case20', () {
      const text = BlueskyText('テストatprotodart.com/test?test=');
      final links = text.links;
    ...
    test('case21', () {
      const text = BlueskyText('テストatprotodart.com/test?test=value');
      final links = text.links;
    ...
    test('case22', () {
      const text = BlueskyText('テストatprotodart.com:8080/test?test=valueあいうえお');
      final links = text.links;
    ...
    test('case24', () {
      const text = BlueskyText('https://test.test');
      final links = text.links;
    ...
    test('case27', () {
      const text = BlueskyText('wikipedia.com/Primer_(film)');
      final links = text.links;
    ...
    test('case28', () {
      const text = BlueskyText('wikipedia.com/Primer_(film)/S(dfd346)/');
      final links = text.links;
    ...
    test('case30', () {
      const text = BlueskyText('wikipedia.com//track/We_Up_...');
      final links = text.links;
    ...
    test('case31', () {
      const text = BlueskyText('''deck.blueの挙動が気になったのでテスト
...
[example link](https://www.picserver.org/assets/library/2020-10-31/originals/example1.jpg)''');
    ...
    group('extended link tests', () {
      ...
      test('link facet generation', () async {
        const text = BlueskyText('https://example.com https://test.org');
        final links = text.links;
  ...
  group('.tags', () {
    ...
    test('case2', () async {
      const text = BlueskyText('#test #test2');
      final tags = text.tags;
    ...
    test('case4', () async {
      const text = BlueskyText("#test's #テスト");
      final tags = text.tags;
    ...
    test('case5', () async {
      const text = BlueskyText('#test#テスト');
      final tags = text.tags;
    ...
    test('case6', () async {
      const text = BlueskyText('''#test @shinyakato.dev
...
🪔 #テスト''');
    ...
    test('case14', () async {
      const text = BlueskyText('#https://shinyakato.dev');
      final tags = text.tags;
    ...
    test('case18', () async {
      const text = BlueskyText('#test_test');
      final tags = text.tags;
    ...
    test('case19', () async {
      const text = BlueskyText('#test_test #test-test');
      final tags = text.tags;
    ...
    group('extended hashtag tests', () {
      ...
      test('hashtag facet generation', () async {
        const text = BlueskyText('#test #example #demo');
        final tags = text.tags;
        final facets = await tags.toFacets();
  ...
  group('.entities', () {
    ...
    test('case2', () {
      const text = BlueskyText('@shinyakato.dev http://text.com');
      final entities = text.entities;
...
''');
    ...
    test('case9', () {
      expect(const BlueskyText('tbh').entities, []);
    });
...
このポストはdeck.blueから。この音楽（https://www.youtube.com/watch?v=lDK9QqIzhwk）をどう思う？''',
    ...
    test('case12', () {
      final text = const BlueskyText('https://deck.blue/page').format();
  ...
  group('markdown links', () {
    test('case1', () {
      final text = const BlueskyText('[test](https://example.com)').format();
    ...
    test('case2', () {
      final text = const BlueskyText('[test](example.com)').format();
    ...
    test('case5', () {
      const text = BlueskyText('[test](https://example.com)');
    ...
    test('case6', () {
      final text = const BlueskyText('[](https://example.com)').format();
    ...
    test('case7', () {
      final text = const BlueskyText('[test]()').format();
    ...
    test('case8', () {
      final text = const BlueskyText('[]()').format();
    ...
    test('case15', () {
      const text = BlueskyText('[テスト](deck.blue)', enableMarkdown: false);
    ...
    test('case16', () {
      const text = BlueskyText('[テスト](deck)');
    ...
    test('case17', () {
      const text = BlueskyText('[@shinyakato.dev](https://example.com)');
    ...
    test('case20', () {
      const text = BlueskyText('[shinyakato](https://example)');
    ...
    test('case21', () {
      const text = BlueskyText('[test]aaaaa[test2](https://shinyakato.dev)');
    ...
    test('case22', () {
      const text = BlueskyText('[test]aaaaa[test2](shinyakato.dev)');
    ...
    test('case23', () {
      const text = BlueskyText('[#test](https://shinyakato.dev)');
  ...
  group('Unicode space characters as tag delimiters (issue #1933)', () {
    test('security - no Unicode normalization attacks', () {
      ...
      const normalSpace = BlueskyText('test #hashtag');
      const nbSpace = BlueskyText('test\u00A0#hashtag');
      const ideographicSpace = BlueskyText('test\u3000#hashtag');
    ...
    test('security - no injection through Unicode spaces', () {
      ...
      const maliciousInput = 'normal\u3000#tag\u00A0javascript:alert(1)';
      const text = BlueskyText(maliciousInput);
      final tags = text.tags;
    ...
    test('should recognize tags separated by full-width space (U+3000)', () {
      const text = BlueskyText('テスト　#U3000 #U0020 #U00A0 #U2000');
      final tags = text.tags;
    ...
    test('should recognize tags separated by common Unicode spaces', () {
      ...
      const text = BlueskyText('#tag1 #tag2\u00A0#tag3\u3000#tag4');
      final tags = text.tags;
