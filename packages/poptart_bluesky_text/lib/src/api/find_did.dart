...
typedef DidResolver = Future<Map<String, dynamic>> Function({required String handle, String? service});

DidResolver _resolver = _resolveDID;

Future<Map<String, dynamic>> findDID({required String handle, String? service}) async =>
    _resolver(handle: handle, service: service);
...
Future<Map<String, dynamic>> _resolveDID({required String handle, String? service}) async {
