import 'package:bsky_moderation/src/decision.dart';
        ...
        actual = moderateProfile(
          ModerationSubjectProfile.profileViewBasic(
            data: m.profileViewBasic(
              handle: 'bob.test',
              displayName: 'Bob',
              labels: [m.label(val: 'custom', uri: 'did:web:bob.test', src: 'did:web:labeler.test')],
            ),
          ),
          modOpts(blurs, severity),
        );
...
List<ModerationTestSuiteResultFlag> _getExpectedResultFlags(final List<dynamic>? flags) {
