...
_ModerationTestSuiteScenario _$ModerationTestSuiteScenarioFromJson(Map json) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = _ModerationTestSuiteScenario(
      ...
      labels: $checkedConvert(
        'labels',
        (v) =>
            (v as Map?)?.map((k, e) => MapEntry(k as String, (e as List<dynamic>).map((e) => e as String).toList())) ??
            const {},
      ),
      behaviors: $checkedConvert(
        ...
        (v) =>
            (v as Map?)?.map(
              (k, e) => MapEntry(
                k as String,
                (e as List<dynamic>).map((e) => $enumDecode(_$ModerationTestSuiteResultFlagEnumMap, e)).toList(),
              ),
            ) ??
            const {},
      ),
...
Map<String, dynamic> _$ModerationTestSuiteScenarioToJson(_ModerationTestSuiteScenario instance) => <String, dynamic>{
  'cfg': instance.cfg,
  'subject': instance.subject,
  'author': instance.author,
  'quoteAuthor': instance.quoteAuthor,
  'labels': instance.labels,
  'behaviors': instance.behaviors.map(
    (k, e) => MapEntry(k, e.map((e) => _$ModerationTestSuiteResultFlagEnumMap[e]!).toList()),
  ),
};
