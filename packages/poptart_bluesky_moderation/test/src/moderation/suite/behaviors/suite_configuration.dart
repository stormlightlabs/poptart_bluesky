...
@freezed
abstract class ModerationTestSuiteConfiguration with _$ModerationTestSuiteConfiguration {
  ...
  factory ModerationTestSuiteConfiguration.fromJson(Map<String, Object?> json) =>
